...
const gs = '\x1D';
const fs = '\x1C';
const dleeot = '\x10\x04';

//Status
const cStatus = '$dleeot\x01';
const cOffLineStatus = '$dleeot\x02';
const cErrorStatus = '$dleeot\x03';
const cPaperSensorStatus = '$dleeot\x04';
...
// Mech. Control
const cCutFull = '${gs}V0'; // Full cut '\x1DV0'
